...
gameLoop = function () {
	...
	break
		case "quit level":
	showWord("Restarting level ...","slide zoom 3",335,240)
...
qlw = 60
	...
	case "user is dragging" :
		...
		break;
	case "level solved" :
	blockHolder.alphaTo(0,1.5,"easeInSine")
	...
	testClip.slideTo(solvedX*50+gridXOffset+100,solvedY*50+gridYOffset,1,"",.5)
		...
		showWord("Level "+level,"slide down bounce",undefined,undefined,1)
